...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/05/09 09:08:50 by loribeir          #+#    #+#             */
/*   Updated: 2025/05/09 18:04:24 by loribeir         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define FAIL 1
# define SUCCESS 0
# define MSG_ERROR "invalid number of time each philosopher must eat\n"
...
void	init_philos(t_philo *philos, t_program *program, pthread_mutex_t *fork, \
					char **av);
